...
{
    public class SalesAzureServiceBusConsumer : ISalesAzureServiceBusConsumer
    {
        ...
        public SalesAzureServiceBusConsumer(IConfiguration config, IMessageBus messageBus)
        {
        ...
        private async Task OnProductCreatedMessageReceived(Message message, CancellationToken cancellationToken)
        {
            ...
            await Console.Out.WriteLineAsync("Sales AzureServiceBusConsumer received: " + body);
        }
